<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Snitch</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/snitch">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/snitch/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/snitch" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs Snitch (OpenSnitch/Little Snitch) on Linux and MacOS</b></br>
</p>
...
This repository contains an Ansible role that installs Snitch (OpenSnitch/Little Snitch) on Linux and MacOS. Little Snitch/OpenSnitch is an application firewall that makes Internet connections visible and puts you back in control!
