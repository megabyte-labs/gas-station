<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><div align="center">
  <center>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/githubbinary">
      <img width="140" height="140" alt="GitHub Binary Downloader logo" src="https://gitlab.com/megabyte-space/ansible-roles/githubbinary/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center">Ansible Role: GitHub Binary Downloader</h1></center>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://galaxy.ansible.com/professormanhattan/githubbinary" title="GitHub Binary Downloader role on Ansible Galaxy" target="_blank">
      <img height="50" src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/ansible-galaxy.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/githubbinary/-/blob/master/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
    ...
    <a href="https://github.com/ProfessorManhattan/ansible-githubbinary" title="GitHub mirror" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/github-solid.svg" />
    </a>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/githubbinary" title="GitLab repository" target="_blank">
      <img src="https://gitlab.com/megabyte-labs/assets/-/raw/master/svg/gitlab-solid.svg" />
    </a>
  </h4>
  <p align="center">
    <a href="https://galaxy.ansible.com/professormanhattan/githubbinary" target="_blank">
      <img alt="Ansible Galaxy role: professormanhattan.githubbinary" src="https://img.shields.io/ansible/role/ansible_galaxy_project_id?logo=ansible&style=flat" />
    </a>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/githubbinary" target="_blank">
      <img alt="Version: 1.0.0" src="https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000" />
    </a>
    <a href="https://github.com/ProfessorManhattan/ansible-githubbinary/actions/Windows.yml" target="_blank">
      <img alt="Windows 10 build status" src="https://img.shields.io/github/workflow/status/ProfessorManhattan/ansible-githubbinary/Windows/master?color=cyan&label=Windows%20build&logo=windows&style=flat">
    </a>
    <a href="https://github.com/ProfessorManhattan/ansible-githubbinary/actions/macOS.yml" target="_blank">
      <img alt="macOS build status" src="https://img.shields.io/github/workflow/status/ProfessorManhattan/ansible-githubbinary/macOS/master?label=macOS%20build&logo=apple&style=flat">
    </a>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/githubbinary/commits/master" target="_blank">
      <img alt="Linux build status" src="https://gitlab.com/megabyte-space/ansible-roles/githubbinary/badges/master/pipeline.svg">
    </a>
    <a href="https://galaxy.ansible.com/professormanhattan/githubbinary" target="_blank" title="Ansible Galaxy quality score (out of 5)">
    ...
    <a href="repository.gitlab_ansible_roles_group/githubbinary/-/raw/master/LICENSE" target="_blank">
...
<!--TERMINALIZER![terminalizer_title](https://gitlab.com/megabyte-space/ansible-roles/githubbinary/-/raw/master/.demo.gif)TERMINALIZER-->
...
Looking to install GitHub Binary Downloader without having to deal with [Ansible](https://www.ansible.com/)? Simply run the following command that correlates to your operating system:

**Linux/macOS:**

```shell
curl -sS https://install.doctor/githubbinary | bash
```

**Windows:**

```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://win.install.doctor/githubbinary'))
```

And there you go. Installing githubbinary can be as easy as that. If, however, you would like to incorporate this into an Ansible playbook (and customize settings) then please continue reading below.
...
This repository is the home of an Ansible role that downloads binaries from GitHub Releases on nearly any platform. This role performs the necessary logic to download and install binaries and other installers from GitHub Releases.
...
- hosts: all
  roles:
    - professormanhattan.githubbinary
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-space/ansible-roles/githubbinary/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-space/ansible-roles/githubbinary/-/raw/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](repository.gitlab_ansible_roles_group/githubbinary/-/raw/master/LICENSE) licensed.
