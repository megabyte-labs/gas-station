<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Start Menu Configuration</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/startmenu">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/startmenu/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/startmenu" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that moves Windows start menu entries to the root level and removes their folders</b></br>
</p>
...
This repository contains an Ansible role that moves Windows start menu entries to the root level and removes their folders
