<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Go</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/go">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/go/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/go" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs Go on nearly any platform</b></br>
</p>
...
This repository contains an Ansible role that installs Go on nearly any platform. Go is a statically typed, compiled programming language designed at Google by Robert Griesemer, Rob Pike, and Ken Thompson. Go is syntactically similar to C, but with memory safety, garbage collection, structural typing, and CSP-style concurrency.
