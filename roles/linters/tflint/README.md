<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: tflint</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/tflint">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/tflint/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/tflint" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that Installs tflint on nearly any platform</b></br>
</p>
...
This repository contains an Ansible role that installs tflint on nearly any platform. tflint is a framework that can help in finding possible errors for major cloud providers, warn about deprecated syntax and unused declarations and enforce best practices.
