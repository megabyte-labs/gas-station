...
def main():
    ...
    if 40500 <= NUM_VERSION < 40590:
        ca_certs = [cert.public_bytes(serialization.Encoding.DER) for cert in ca_certs]
    ...
    module.exit_json(changed=True, ca_enabled=ca_enabled, subject_base=subject_base)
