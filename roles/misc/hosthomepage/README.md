<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Host Home Page</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/hosthomepage">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/hosthomepage/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/hosthomepage" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs a homepage on the FQDN of the client which includes links to tools also installed such as Adminer, Duplicacy, and File Browser (all apps that need to be installed on each individual host)</b></br>
</p>
...
This repository contains an Ansible role that installs a homepage on the FQDN of the client which includes links to tools also installed such as Adminer, Duplicacy, and File Browser (all apps that need to be installed on each individual host). 
