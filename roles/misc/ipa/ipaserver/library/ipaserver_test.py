...
def main():
    ...
    if options.pki_config_override is not None:
        if PKIIniLoader is None:
            ...
            try:
                PKIIniLoader.verify_pki_config_override(options.pki_config_override)
            except ValueError as e:
                ansible_module.fail_json(msg="pki_config_override: %s" % str(e))
    ...
    if not options.no_ntp:
        try:
            ...
            ansible_module.log(
                ...
                "'%s' will be disabled in favor of chronyd" % e.conflicting_service
            )
