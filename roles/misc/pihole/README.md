<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: PiHole</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/pihole">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/pihole/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/pihole" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that automates the process of installing PiHole with Cloudflared (encrypted DNS).</b></br>
</p>
...
This repository contains an Ansible role that automates the process of installing PiHole with Cloudflared (encrypted DNS). Pi-hole is a Linux network-level advertisement and Internet tracker blocking application which acts as a DNS sinkhole and optionally a DHCP server, intended for use on a private network. It is designed for low-power embedded devices with network capability, such as the Raspberry Pi, but supports any Linux machines.
