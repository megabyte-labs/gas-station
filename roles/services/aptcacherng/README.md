<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: AptCacherNG</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/aptcacherng">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/aptcacherng/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/aptcacherng" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs AptCacherNG on a server or configures clients to use the AptCacherNG endpoint</b></br>
</p>
...
This repository contains an Ansible role that installs AptCacherNG on a server or configures clients to use the AptCacherNG endpoint. Apt-Cacher-NG is a caching proxy server (or apt proxy) for Debian based distributions like Ubuntu, Kubuntu, Xubuntu, Edubuntu, Linux Mint, etc, which is used to cache the downloaded packages locally on your server.
