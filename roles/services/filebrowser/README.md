<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: File Browser</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/filebrowser">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/filebrowser/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/filebrowser" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that sets up File Browser which is a tool that lets you browse and edit files on any mounting point in the operating system</b></br>
</p>
...
This repository contains an Ansible role that sets up File Browser which is a tool that lets you browse and edit files on any mounting point in the operating system.
