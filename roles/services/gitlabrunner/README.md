<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Gitlab Runner</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/gitlabrunner">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/gitlabrunner/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/gitlabrunner" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that sets up Gitlab Runner which is a tool that lets you browse and edit files on any mounting point in the operating system</b></br>
</p>
...
This repository contains an Ansible role that sets up Gitlab Runner on nearly any platform. GitLab Runner is an application that works with GitLab CI/CD to run jobs in a pipeline.
