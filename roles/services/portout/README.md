<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Portout</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/portout">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/portout/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/portout" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs portout which is a service that monitors outgoing traffic and logs the port they use to a database</b></br>
</p>
...
This repository contains an Ansible role that installs portout which is a service that monitors outgoing traffic and logs the port they use to a database. 
