<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: Consul-template</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/consultemplate">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/consultemplate/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/consultemplate" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs Consul-template on nearly any platform</b></br>
</p>
...
This repository contains an Ansible role that installs Consul-template on nearly any platform. Consul-template provides a convenient way to populate values from Consul into the file system using the consul-template daemon.
