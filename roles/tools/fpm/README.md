<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: fpm</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/fpm">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/fpm/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/fpm" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs fpm on Linux and MacOS</b></br>
</p>
...
This repository contains an Ansible role that installs fpm on Linux and MacOS. fpm allows building packages for multiple platforms (deb, rpm, etc) with great ease and sanity
