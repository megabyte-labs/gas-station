<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: git-fuzzy</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/gitfuzzy">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/gitfuzzy/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  ...
  <a href="https://megabyte.space/docs/gitfuzzy" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>This repository contains an Ansible role that installs git-fuzzy on Linux and MacOS</b></br>
</p>
...
This repository contains an Ansible role that installs git-fuzzy on Linux and MacOS. git-fuzzy is interactive `git` with the help of `fzf`
