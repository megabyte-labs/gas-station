<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><h1 align="center" style="text-align:center;">Ansible Role: s3filesystem</h1>

<div align="center">
  <h4>
    <a href="https://gitlab.com/ProfessorManhattan/Playbooks">Main Playbook</a>
    <span> | </span>
    <a href="https://galaxy.ansible.com/professormanhattan/s3filesystem">Galaxy</a>
    <span> | </span>
    <a href="https://gitlab.com/megabyte-space/ansible-roles/s3filesystem/-/blob/master/CONTRIBUTING.md">Contributing</a>
    <span> | </span>
...
<p style="text-align:center;">
  <a href="https://gitlab.com/megabyte-space/ansible-roles/s3filesystem">
    <img alt="Version" src="https://img.shields.io/badge/version-0.0.1-blue.svg?cacheSeconds=2592000" />
  </a>
  <a href="https://megabyte.space/docs/s3filesystem" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg" />
  </a>
  <a href="repository.gitlab_ansible_roles_group/s3filesystem/-/raw/master/LICENSE" target="_blank">
...
<p align="center" style="text-align:center;">
  <b>An Ansible role that installs s3filesystem on nearly any platform</b></br>
</p>
...
This repository contains an Ansible role that installs catfs and goofys on Linux and Mac OS. Catfs allows you to have cached access to another (possibly remote) filesystem. Caching semantic is read-ahead and write-through. Goofys is a high-performance, POSIX-ish Amazon S3 file system written in Go, which allows you to mount an S3 bucket as a filey system. It's a Filey System instead of a File System because goofys strives for performance first and POSIX second.
...
- hosts: all
  roles:
    - professormanhattan.s3filesystem
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-space/ansible-roles/s3filesystem/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-space/ansible-roles/s3filesystem/-/raw/master/CONTRIBUTING.md).
...
Copyright © 2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](repository.gitlab_ansible_roles_group/s3filesystem/-/raw/master/LICENSE) licensed.
