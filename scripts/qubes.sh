...
ansible-playbook -vvvvv --skip-tags dotfiles --vault-password-file ~/.vaultpass -i /etc/ansible/inventories/quickstart.yml /etc/ansible/qubes.yml | tee ~/ansible-log.txt
